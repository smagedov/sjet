...
spheres3d(jet_1$eta, jet_1$phi, jet_1$dist, col = "red", radius = (jet_1_pt)^(1/3)*size_scale)
spheres3d(jet_2$eta, jet_2$phi, jet_2$dist, col = "blue", radius = (jet_2_pt)^(1/3)*size_scale)
spheres3d(jet_3$eta, jet_3$phi, jet_3$dist, col = "green", radius = (jet_3_pt)^(1/3)*size_scale)
spheres3d(jet_4$eta, jet_4$phi, jet_4$dist, col = "yellow", radius = (jet_4_pt)^(1/3)*size_scale)
spheres3d(jet_5$eta, jet_5$phi, jet_5$dist, col = "magenta", radius = (jet_5_pt)^(1/3)*size_scale)
spheres3d(jet_6$eta, jet_6$phi, jet_6$dist, col = "coral", radius = (jet_6_pt)^(1/3)*size_scale)
spheres3d(jet_7$eta, jet_7$phi, jet_7$dist, col = "orange", radius = (jet_7_pt)^(1/3)*size_scale)
...
labels = c("Jet 1", "Jet 2", "Jet 3", "Jet 4", "Jet 5", "Jet 6", "Jet 7")
colors = c("red", "blue", "green", "yellow", "magenta", "coral", "orange")
