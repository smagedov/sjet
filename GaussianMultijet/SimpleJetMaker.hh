#ifndef SIMPLEJETMAKER_HH_
#define SIMPLEJETMAKER_HH_
...
class SimpleJetMaker : public frw::AbsFrameworkModule<Event>
{
public:
    typedef Event event_type;
    typedef frw::AbsFrameworkModule<Event> Base;

    inline SimpleJetMaker(const std::string& i_label,
    ...
    inline virtual ~SimpleJetMaker() override {}

    inline virtual SimpleJetMaker* clone() const override
        {return new SimpleJetMaker(*this);}
